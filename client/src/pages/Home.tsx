 ...
 * Sections: Nav, Hero, About, Products, Gallery, Custom Orders, Instagram, Contact, Footer
 */

import { useEffect, useRef, useState } from "react";
import { motion, useScroll, useTransform, AnimatePresence } from "framer-motion";
import { Instagram, Mail, Phone, MapPin, Star, ChevronDown, X, Menu, ShoppingBag, Sparkles, Heart } from "lucide-react";
import { toast } from "sonner";

// ─── Asset URLs ────────────────────────────────────────────────────────────────
const ASSETS = {
  logo: "/manus-storage/logo_18ad5120.png",
...
function Navigation() {
  ...
  const navLinks = ["Home", "About", "Collection", "Gallery", "Custom Orders", "Contact"];
      ...
      >
        <div className="container flex items-center justify-between">
          ...
          <button onClick={() => scrollTo("home")} className="flex items-center gap-3">
            <img src={ASSETS.logo} alt="ShaRiz Kreations" className="h-12 w-auto" />
          </button>
          ...
          <div className="hidden lg:flex items-center gap-8">
            {navLinks.map((link) => (
              <button
                ...
                className="text-xs tracking-widest uppercase font-medium text-cream/70 hover:text-[#D4AF37] transition-colors duration-300"
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="hidden lg:block btn-gold rounded-none text-xs"
            >
              Order Now
            </button>
            <button
        ...
        {menuOpen && (
          ...
          >
            <div className="flex justify-between items-center p-6 border-b border-[#D4AF37]/20">
              <img src={ASSETS.logo} alt="ShaRiz Kreations" className="h-10 w-auto" />
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div ref={ref} className="reveal">
            ...
            <p className="text-cream/70 leading-relaxed mb-10" style={{ fontFamily: "'Jost', sans-serif", fontWeight: 300 }}>
              With 125+ posts and a growing community of 329 followers on Instagram, every creation tells a story. Custom orders are my specialty — I love bringing your vision to life.
            </p>
            ...
            >
              ...
              <div className="p-8 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-sm text-cream/50 mb-4" style={{ fontFamily: "'Jost', sans-serif" }}>{selected.subtitle}</p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {TESTIMONIALS.map((t, i) => (
            ...
            >
              ...
              <p className="text-cream/70 text-sm leading-relaxed mb-6 italic" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.05rem" }}>
                "{t.text}"
              </p>
              ...
              <div
                className="absolute top-4 right-6 text-6xl leading-none opacity-10"
          ...
          >
            {submitted ? (
              <div className="text-center py-12">
                ...
                <p className="text-cream/60 text-sm" style={{ fontFamily: "'Jost', sans-serif" }}>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-3xl mx-auto">
          {[
            ...
            },
            {
              icon: Mail,
              title: "Email",
              value: "sharizkreations@gmail.com",
              href: "mailto:sharizkreations@gmail.com",
            },
            {
              icon: MapPin,
              title: "Location",
      ...
      <div className="container">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            <img src={ASSETS.logo} alt="ShaRiz Kreations" className="h-12 w-auto" />
            <div>
              <p className="text-cream/80 text-sm font-medium" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>ShaRiz Kreations</p>
          ...
          <div className="flex items-center gap-6">
            {["Home", "About", "Collection", "Gallery", "Contact"].map((link) => (
              <button
                key={link}
